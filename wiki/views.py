...
def add_article(request):
    ...
    if form.is_valid():
        ...
        #article is the name of model which has absolute url, and it is redirecting to that absolute url.
        return redirect(article)
        # return reverse('wiki:wiki_article_detail')
        # return redirect('wiki:wiki_article_detail')
